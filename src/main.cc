...
void print_roi_stats(uint32_t cpu, CACHE *cache)
{
    ...
    cout<<"P1: "<<cache->p1<<" P2: "<<cache->p2<<endl;
...
void print_sim_stats(uint32_t cpu, CACHE *cache)
{
    ...
    //cache->filef<<cache->sim_access[cpu][2]<<" "<<cache->sim_hit[cpu][2]<<" "<<cache->sim_miss[cpu][2]<<endl;
